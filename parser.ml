...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 74 "parser.mly"
                      ( match _1 with B.B.VAR(x) -> B.B.CALLR (x, _3) | _ -> raise ParsingError )
# 497 "parser.ml"
               : 'expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 3 : 'expr) in
...
let program (lexfun : Lexing.lexbuf -> token) (lexbuf : Lexing.lexbuf) =
   (Parsing.yyparse yytables 1 lexfun lexbuf : B.B.exp)
;;
